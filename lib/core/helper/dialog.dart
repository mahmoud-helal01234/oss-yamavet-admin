               ...
               child: Column(children: [
                 ...
                 Row(
                   ...
                   children: [
                     ...
                     onUpdatePress == null ? Container():MaterialButton(
                       elevation: 10,
                       minWidth: mediaWidth > 650 ? 200 : 140,
                       height: mediaWidth > 650 ? 35 : 25,
                       shape: RoundedRectangleBorder(
...
Future<void> dialogBuilderOrder(BuildContext context, TextAlign textAlign, int appointmentIndex) {
                  ...
                  child: Container(
                    ...
                    child: Stack(
                      children: [
                        ...
                        Consumer<AppointmentsProvider>(
                            builder: (context, appointmentsProvider, child) {
                              return appointmentsProvider.appointments[appointmentIndex].status == "initiated" || appointmentsProvider.appointments[appointmentIndex].status == "accepted" ? Positioned(
                              bottom: 20,
                              ...
                              child: MaterialButton(
                                ...
                                shape: RoundedRectangleBorder(
                                    borderRadius: BorderRadius.circular(5)),
                                onPressed: ()async{
                                  if(Provider.of<AppointmentsProvider>(context, listen: false).
                                  appointments[appointmentIndex].status == "initiated")
                                    {
                                      await Provider.of<
                                    ...
                                    await Provider.of<
                                        ...
                                        context,
                                        listen: false)
                                        .complete(context, appointmentIndex);
                                  }

                                },
                                child: Text(
                                  appointmentsProvider.appointments[appointmentIndex].status == "initiated" ? "Accept" : "Complete",
                                  style: TextStyle(
                                      color: primary,
