...
class _UpdateServicesState extends State<UpdateService> {
  ...
  void initState() {
    super.initState();
    name_en.text = Provider.of<CategoriesProvider>(context, listen: false)
        .serviceToUpdate!
        .nameEn!;
    name_ar.text = Provider.of<CategoriesProvider>(context, listen: false)
        .serviceToUpdate!
        .nameAr!;
    price.text = Provider.of<CategoriesProvider>(context, listen: false)
        .serviceToUpdate!
        .price
        .toString();
  }
  ...
  Future updateServices(UpdateServiceRequest updateServiceRequest) async {
    ...
    http.Response response = await http.post(Uri.parse(updateServicesLink),
  ...
  Widget build(BuildContext context) {
    ...
    return _isLoading!
        ...
        : Center(
            child: Container(
              width: .9 * mediaWidth,
              height: mediaWidth > 650 ? .25 * mediaHeight : .2 * mediaHeight,
              decoration:
                        ...
                        children: [
                          ...
                          InkWell(
                            ...
                            child: Row(
                              ...
                              children: [
                                Container(
                                  width: mediaWidth > 650 ? 200.w : 235.w,
                          ...
                          Row(
                            ...
                            children: [
                              Container(
                                width: mediaWidth > 650 ? 300.w : 235.w,
                                height: mediaWidth > 650 ? 40.h : 30.h,
                                decoration: BoxDecoration(
                                    borderRadius: BorderRadius.circular(5.sp),
                                    border: Border.all(color: Colors.grey)),
