                      ...
                      (Provider.of<SettingsProvider>(context, listen: true).role != 'vet') ? Row(
                        ...
                        children: [
                         ...
                         SizedBox(
                          ...
                          Provider.of<AppointmentsProvider>(context,listen: true).appointments[widget.appointmentIndex].type == "emergancy" ?Container(): MaterialButton(
                            // elevation: 5,
                            minWidth: mediaWidth > 650 ? 400.w : 150.w,
                            height: mediaWidth > 650 ? 40.h : 30.h,
                            shape: RoundedRectangleBorder(
                        ...
                        children: [
                          ...
                          Column(
                            children: [
                              ...
                              Provider.of<AppointmentsProvider>(context, listen: true).appointments[widget.appointmentIndex].doctor != null &&
