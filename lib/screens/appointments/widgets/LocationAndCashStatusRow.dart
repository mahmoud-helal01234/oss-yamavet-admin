...
class LocationAndCashStatusRow extends StatefulWidget {
  ...
  @override
  State<LocationAndCashStatusRow> createState() => _LocationAndCashStatusRowState();
}
      ...
      children: [
        ...
        Consumer<AppointmentsProvider>(
            builder: (context, appointmentsProvider, child) {
              return Text(
                appointmentsProvider.appointments[widget.appointmentIndex].clientLocation!.description!,
              style: TextStyle(
                        ...
                        child: Row(
                          children: [
                            ...
                            Consumer<AppointmentsProvider>(
                                builder: (context, appointmentsProvider, child) {
                                  return Text(
                                  appointmentsProvider.appointments[widget.appointmentIndex].cash!,
                                  style: TextStyle(
                                      fontFamily: 'futur',
                            ...
                            showMenu(
                                ...
                                items: [
                                  PopupMenuItem(
                                      onTap: () {
                                        ...
                                        Provider.of<AppointmentsProvider>(context, listen: false)
                                            .changeCashStatusByIndex(context,widget.appointmentIndex,"collected");
                                  ...
                                  PopupMenuItem(
                                      onTap: () {
                                        Provider.of<AppointmentsProvider>(context, listen: false)
                                            .changeCashStatusByIndex(context,widget.appointmentIndex,"not_collected");
